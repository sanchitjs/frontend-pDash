...
const LoginPage = () => {
    ...
    return (
        <div className=" w-full h-[80vh] flex justify-center px-20 py-10 text-white items-center">
            <div className='flex items-center w-full second:px-32 gap-[200px] justify-between '>
                <div className="left flex w-[1000px] justify-center items-center">
                    <div className=' flex flex-col items-start'>
                        <div className='text-[80px] third:text-[110px] w-fit m-0'>PDash</div>
                        <div className='text-lg third:text-2xl w-fit '>
                            <span>Unlock the Future of Robotics with Photom Technologies</span>
                ...
                <div className="right backdrop-blur-lg rounded-lg flex flex-col justify-center gap-7 p-5 py-10 min-w-[500px] relative shadow-[0_20px_96px_6px_rgb(0,0,0)]">
                    ...
                    <div>
                        <div className='text-md flex justify-between items-end'>
                            ...
                            <span onClick={() => { handleForgotPassword() }} className='text-[blue] text-[10px] font-bold underline my-[2px] cursor-pointer'>forgot password?</span>
                        </div>
                    ...
                    <div className='flex flex-col items-center justify-center rounded-full h-[45px] mt-5'>
                        <button onClick={(e) => { handleLogin(e) }} className=' border-solid border-2 border-black text-black py-2 my-1  rounded-lg transition-all duration-300 w-[98%] hover:w-[100%] hover:bg-[#000000] hover:border-none hover:text-white '>Login</button>
                        {/* {(islogin) ?
